...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_lock = QtWidgets.QGroupBox(self.tab)
        self.groupBox_lock.setObjectName("groupBox_lock")
        self.verticalLayout_2.addWidget(self.groupBox_lock)
        self.horizontalLayout_lock = QtWidgets.QHBoxLayout(self.groupBox_lock)
        self.horizontalLayout_lock.setObjectName("horizontalLayout_lock")
        self.buttonGroup_lock = QtWidgets.QButtonGroup(MainWindow)
        self.buttonGroup_lock.setObjectName("buttonGroup_lock")
        self.radioButton_lock = QtWidgets.QRadioButton(self.groupBox_lock)
        self.radioButton_lock.setChecked(True)
        self.radioButton_lock.setObjectName("radioButton_lock")
        self.buttonGroup_lock.addButton(self.radioButton_lock)
        self.horizontalLayout_lock.addWidget(self.radioButton_lock)
        self.radioButton_lock_2 = QtWidgets.QRadioButton(self.groupBox_lock)
        self.radioButton_lock_2.setObjectName("radioButton_lock_2")
        self.buttonGroup_lock.addButton(self.radioButton_lock_2)
        self.horizontalLayout_lock.addWidget(self.radioButton_lock_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_lock.setTitle(_translate("MainWindow", "圣遗物锁操作"))
        self.radioButton_lock.setText(_translate("MainWindow", "获取游戏锁状态并保存"))
        self.radioButton_lock_2.setText(_translate("MainWindow", "将圣遗物锁同步至游戏"))
